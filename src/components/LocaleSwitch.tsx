...
export function LocaleSwitch({ themeConfig }: { themeConfig?: ThemeConfig }) {
    ...
    // 获取当前语言显示文本
    const currentLocaleConfig = themeConfig?.i18n?.find(l => l.locale === currentLocale) || themeConfig?.i18n?.[0]

    if (!themeConfig?.i18n?.length) return null
